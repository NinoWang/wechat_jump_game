...
def jump(distance):
    ...
    cmd = 'adb shell input swipe {x1} {y1} {x2} {y2} {duration}'.format(
        x1=swipe_x1+random.randint(-100,150),
        y1=swipe_y1+random.randint(-100,150),
        x2=swipe_x2+random.randint(-100,150),
        y2=swipe_y2+random.randint(-100,150),
        duration=press_time+random.randint(-5,5)
    )
    print(cmd)
    os.system(cmd)
    return press_time
